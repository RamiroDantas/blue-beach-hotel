 ...
 */
public class ImprimirRel extends javax.swing.JFrame {
    Connection conexao = null;
    /**
     * Creates new form ImprimirRel
     */
    public ImprimirRel() {
        initComponents();
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        try {
            JasperPrint print = JasperFillManager.fillReport("C:\\Users\\ACER\\Documents\\NetBeansProjectsw\\SHotel\\reports\\Gerentes.jasper", null, conexao);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImprimirRel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
