 ...
 */
public class UsuárioNCadastrado extends javax.swing.JFrame {

    /**
     * Creates new form UsuárioNCadastrado
     */
    public UsuárioNCadastrado() {
        initComponents();
    }
    ...
    private void btnLogin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogin1ActionPerformed
        UsuárioNCadastrado.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            for (javax.swing.UIManager.LookAndFeelInfo info : javax.swing.UIManager.getInstalledLookAndFeels()) {
                if ("Metalc".equals(info.getName())) {
                    javax.swing.UIManager.setLookAndFeel(info.getClassName());
                    break;
                }
            }
        } catch (ClassNotFoundException ex) {
            java.util.logging.Logger.getLogger(UsuárioNCadastrado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
